...
public class Emprestimo {
    ...
    public Emprestimo (String tituloLivro, int idLivro, String userName, LocalDate dataDeEmprestimo, LocalDate dataDeDevolucao){
    ...
    public Emprestimo(String tituloLivro, int idLivro, String userName) {
        this(tituloLivro, idLivro, userName, LocalDate.now(), LocalDate.now().plusDays(15));
    }
